...
class output_summary():
    def __init__(self, start_date_time, start_time, end_time, bore, model_parameters, keras_model, sklearn_model):
        ...
        self.temp_input_graphs_path_1 = import_functions.path(f'/{self.bore_id}/temp/', 'temp_input_graphs_1.pdf')
        self.temp_input_graphs_file_1 = PdfPages(self.temp_input_graphs_path_1)
        
        self.temp_input_graphs_path_2 = import_functions.path(f'/{self.bore_id}/temp/', 'temp_input_graphs_2.pdf')
        self.temp_input_graphs_file_2 = PdfPages(self.temp_input_graphs_path_2)
        
        self.temp_input_graphs_path_3 = import_functions.path(f'/{self.bore_id}/temp/', 'temp_input_graphs_3.pdf')
        self.temp_input_graphs_file_3 = PdfPages(self.temp_input_graphs_path_3)  
        
        self.temp_input_graphs_path_4 = import_functions.path(f'/{self.bore_id}/temp/', 'temp_input_graphs_4.pdf')
    ...
    def create_general_text(self):
        ...
        self.data_start = data_range_start_date
        self.data_end = data_range_end_date 
    ...
    def create_input_variable_graphs(self):
        ...
        for p in range(pages):
            ...
            fig.tight_layout()
            # plt.savefig(self.temp_input_graphs_file_1, format='pdf') # Line prone to TimeoutErrors
            # plt.savefig(self.temp_input_graphs_file, format='pdf') # Line prone to TimeoutErrors
            # ---> self.temp_input_graphs_file.savefig(fig) <---
        ...
        for p in range(pages):
            ...
            fig.tight_layout()
            # plt.savefig(self.temp_input_graphs_file_2, format='pdf') # Line prone to TimeoutErrors
            # plt.savefig(self.temp_input_graphs_file, format='pdf') # Line prone to TimeoutErrors
            # ---> self.temp_input_graphs_file.savefig(fig) <---
        ...
        if num_combinations >= 1:
            ...
            for p in range(vertical_divisions):
                ...
                for q in range(horizontal_divisions):
                    ...
                    # plt.savefig(self.temp_input_graphs_file_3, format='pdf')
    ...
    def create_spreadsheet(self):
        ...
        value = [self.bore_id,
                 ...
                 self.data_end,
                 self.bore.av_period,
                 f'{100 - self.model_parameters.test_size * 100}%',
                 f'{self.model_parameters.test_size * 100}%',
