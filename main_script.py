...
class main_script():
    def run(self, other_variables):
        ...
        gwl_input = 'average' # 'standard', 'delta', 'none', 'average', 'average_delta'
        gwl_output = 'average' # 'standard', 'delta', 'average', 'average_delta'
        
        times_in = 3 # time lags 
        ...
        optimiser ='adam'
        loss ='mse' # 'mse', 'mae'
        metric = RMSE() #'accuracy' #RMSE() # 'accuracy'
        epochs = 100 # 200
...
# Uncomment below to run script from this script

# main_script = main_script()
# main_script.run(other_variables)
