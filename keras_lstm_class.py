...
class keras_LSTM():
    def __init__(self, optimiser='adam', loss='mse', metric='accuracy', epochs=200, keras_validation_split=0.2, shuffle_order=False, verbose=0):
        ...
        self.metric = metric  
        """MAKE METRIC SO IT WORKS AS A LIST"""
    ...
    def create_network(self, input_shape, num_lstm_cells=64, num_fc_neurons=8, lstm_dropout_rate=0, lstm_recurrent_dropout_rate=0, num_outputs=1):
